export const TEXT = {
  ...
  QnA: [
    ...
    },
    {
      question: '노트북이 필요한가요?',
      answer:
        '멋쟁이사자처럼 12기 활동을 위해서는 꼭 개인 노트북이 필요합니다.',
    },
    {
      question: '회비가 존재하나요?',
      answer: '인원당 4만원의 회비가 존재합니다.',
    },
    {
      question: '지각/결석 시 어떻게 되나요?',
      answer:
        '지각 시 분당 1000원을 부과합니다. 30분이상 지각 시 결석으로 간주합니다. 학기당 결석권 1회가 존재합니다. 지각/결석 규칙은 학교 출석인정요청서 내 규정과 동일합니다.',
    },
  ],
};
